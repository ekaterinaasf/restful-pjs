...
(async function RESTfulFetchExample() {
  ...
  try {
    const rez = await fetch("http://127.0.0.1:3000/todos", {
      method: "POST",
    ...
    const output = await rez.json();
    console.log(timedMsg("response" + exampleStep1), output);
  } catch (err) {
  ...
  fetch("http://127.0.0.1:3000/todos/1", {
    method: "GET",
  })
    .then((res) => res.json())
  ...
  const exampleStep3 =
    " 3 -> reading new todo by id query  (default GET method)";
  ...
  fetch("http://127.0.0.1:3000/todos?id=1")
    .then((res) => res.json())
  ...
  fetch("http://127.0.0.1:3000/todos?todoText=" + bodyQuery)
    .then((res) => res.json())
  ...
  await fetch("http://127.0.0.1:3000/todos/2", {
    method: "PUT",
  ...
  await fetch("http://127.0.0.1:3000/todos/3", {
    method: "PATCH",
    body: JSON.stringify({ completed: true }),
    headers: {
      "Content-type": "application/json; charset=UTF-8",
  ...
  fetch("http://127.0.0.1:3000/todos/5", {
    method: "DELETE",
  })
    .then((res) => res.json())
  ...
  await fetch("http://127.0.0.1:3000/todos?completed=true")
    .then((res) => res.json())
  ...
  fetch("http://127.0.0.1:3000/todos?completed=true")
    .then((res) => res.json())
